...
$(document).ready(function () {
  // 여기에요!! 내가 커스터마이징 해버렸어요!
  $(".collapse-link-custom").on("click", function () {
    var e = $(this).closest(".x_panel.custom"),
      a = $(this).find("i"),
      t = e.find(".x_content.custom");
    e.attr("style")
      ? t.slideToggle(200, function () {

        })
      : (t.slideToggle(200), e.css({"height" : "auto", "border" : "none"})),
...
*/
  ...
  ---------------------------------------------
  */
  function meeting_newteb() {
      window.open("https://probada-online-meeting.netlify.app/create", "_blank");
  }
