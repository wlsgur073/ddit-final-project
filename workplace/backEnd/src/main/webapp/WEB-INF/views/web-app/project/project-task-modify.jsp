...
<div class="right_col" role="main">
  ...
  <div class="x_panel">
    <div class="x_content">
      <!-- 제목 시작 -->
      <div class="x_title">
        <h2><i class="glyphicon glyphicon-exclamation-sign"></i>&nbsp;&nbsp;&nbsp;업무 수정</h2>
        <button type="button" class="btn btn-sm btn-secondary float-right" onclick="history.go(-1);">취소</button>
        <button type="button" class="btn btn-sm btn-primary float-right">저장</button>
      ...
      <div class="form-group row">
        <div class="col-sm-6">
          <label>제목 :</label>
          <input type="text" class="form-control form-control-sm" value="칸반보드 화면 구현">
        </div>
        <div class="col-sm-6">
          <label>프로젝트명 :</label>
