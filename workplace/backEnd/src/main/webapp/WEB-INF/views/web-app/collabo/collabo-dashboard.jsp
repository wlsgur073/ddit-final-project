...
<div class="col-md-6 col-sm-6" style="min-height:340px;">
		...
		<div class="x_content">
			<div class="DashboardTable" id="CollaboTaskDashboard"></div>
		</div>
	</div>
...
<div class="col-md-6 col-sm-6" style="min-height:340px;">
		...
		<div class="x_content">
			<div class="DashboardTable" id="cprojIssueDashboard"></div>
		</div>
	</div>
...
<!-- <div class="col-md-6 col-sm-6 pr-0">
 ...
 -->
		<div class="col-md-6 col-sm-6">
			...
			<div class="x_content">
				<div id="cprojectHistoryDashboard"></div>
			</div>
		</div>
	...
	<div class="col-md-6 col-sm-6" style="min-height:340px;">
		...
		<div class="x_content">
			<div class="DashboardTable" id="cprojectDocumentDashboard"></div>
		</div>
	</div>
	...
	<div class="col-md-12 col-sm-12 pl-0">
		...
		<div class="x_content d-flex justify-content-center">
			<div class="chart-container" style="width: 100%; height: auto;">
				<canvas id="get_cproj_member_achievement"></canvas>
			</div>
		</div>
	</div>
