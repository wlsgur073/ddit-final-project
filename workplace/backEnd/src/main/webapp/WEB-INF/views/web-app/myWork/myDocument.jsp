...
<script>
	...
	var baseUrl = "<%=request.getContextPath()%>/document/";
	...
	var DownloadCommand = Command.extend({
		...
		exec: function(){
			var that = this, target = that.options.target, filemanager = that.filemanager, item = filemanager._view.widgetComponent.dataItem(target);  
	...
	$("#filemanager").kendoFileManager({
		...
		filemanager.upload.bind("upload", function (e) {
		console.log('hello');
		e.data = {
